...
export const metadata: Metadata = {
  title: "Premium Used & New Cars | AutoMax Dealership",
  description: "Find your perfect car at AutoMax. Premium vehicle selection, transparent pricing, flexible financing, and exceptional service. Shop quality used and new cars today.",
  keywords: "car dealership, used cars, new cars, auto sales, car financing, vehicle warranty",
  openGraph: {
    title: "Premium Cars for Sale | AutoMax Dealership",
    description: "Explore quality vehicles with transparent pricing and flexible financing options.",
    siteName: "AutoMax",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1766054405966-xwrk23d1.jpg",
      alt: "Premium luxury car showroom"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Premium Cars for Sale | AutoMax",
    description: "Quality vehicles with transparent pricing and exceptional service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1766054405966-xwrk23d1.jpg"]
  },
  robots: {
    index: true,
    follow: true
